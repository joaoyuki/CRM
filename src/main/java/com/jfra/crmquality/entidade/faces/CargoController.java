...
import com.jfra.crmquality.entidade.faces.EJB.CargoFacade;
...
public class CargoController implements Serializable {
    ...
    @EJB
    private com.jfra.crmquality.entidade.faces.EJB.CargoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("CargoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("CargoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("CargoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
        ...
        if (selected != null) {
            ...
            try {
                if (persistAction == PersistAction.CREATE){
                    getFacade().salvaCargo(selected);
                }else if (persistAction == PersistAction.DELETE) {
                    getFacade().remove(selected);
                } else {
                    getFacade().editaCargo(selected);
                }
    ...
    public String getNomeCargoBayID(Integer id){
